...
public class DocAutoChartModule extends AbstractQuercusModule {
  ...
  protected abstract static class WsdChart2 {
    ...
    public WsdChart2 setBackgroundGradient(float x1, float y1, int r1, int g1, int b1, float x2, float y2, int r2, int g2, int b2, boolean cyclic) {
    ...
    protected Stroke stroke(float weight, String style) {
      if ("dotted".equals(style)) {
        return new BasicStroke(weight, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0.0f, new float[] {
          2.0f,
          2.0f
        },
        0.0f);
        ...
        return new BasicStroke(weight, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[] {
          10.0f
        },
        0.0f);
      }
  ...
  protected static class WsdBarChart2 extends WsdChart2 {
    ...
    private Map < String,
    Color > barColors = new HashMap < String,
    Color > ();
    ...
    public void setNumbersOnTopOfBars(boolean on, String labelFormat, String formatter, String percentFormatter) {
      ...
      if (on) {
        ...
        labelFormat, new DecimalFormat(formatter), new DecimalFormat(percentFormatter)));
    ...
    public void addIntervalMarker(final double start, final double end, final String labelText, final String labelFontName, final int labelFontStyle, final int labelFontSize, final String labelAnchor, final String labelTextAnchor, final int labelR, final int labelG, final int labelB, final int labelA, final int r, final int g, final int b, final int a, final String intervalLayer) {
  ...
  protected abstract static class WsdXYChart2 extends WsdChart2 {
    ...
    public void setOverrideTicks(Number[] numbers) {
      if (plot.getDomainAxis() instanceof ArbitraryTicksNumberAxis) { ((ArbitraryTicksNumberAxis) plot.getDomainAxis()).setNumbers(Arrays.asList(numbers));
      }
    }

    public void hack() { ((ArbitraryTicksDateAxis) plot.getDomainAxis()).hack();
    }
    ...
    public void setOverrideTicksDates(Number[] numbers) {
      if (plot.getDomainAxis() instanceof ArbitraryTicksDateAxis) { ((ArbitraryTicksDateAxis) plot.getDomainAxis()).setNumbers(Arrays.asList(numbers));
      }
    }
    ...
    public void addNonPointerAnnotation(String label, String labelFont, int labelFontStyle, int labelFontSize, double x, double y, int r, int g, int b) {

      XYTextAnnotation annotation = new XYTextAnnotation(label, x, y);

      annotation.setFont(new Font(labelFont, labelFontStyle, labelFontSize));
    ...
    public void addXYPolygonAnnotationOutline(Env env, ArrayValue av, int or, int og, int ob, int oa, Float weight, String style, boolean background) {

      double[] d = getDoubleArray(av);
      XYPolygonAnnotation polygon = new XYPolygonAnnotation(d, stroke(weight, style), new Color(or, og, ob, oa));

      plot.getRenderer().addAnnotation(polygon, background ? Layer.BACKGROUND: Layer.FOREGROUND);
    }

    public void addXYPolygonAnnotation(Env env, com.caucho.quercus.env.ArrayValue av, int or, int og, int ob, int oa, int fr, int fg, int fb, int fa, Float weight, String style, boolean background) {

      double[] d = getDoubleArray(av);
      XYPolygonAnnotation polygon = new XYPolygonAnnotation(d, stroke(weight, style), new Color(or, og, ob, oa), new Color(fr, fg, fb, fa));
    ...
    public void addXYShapeAnnotationOutline(Env env, Shape shape, int or, int og, int ob, int oa, Float weight, String style, boolean background) {

      XYShapeAnnotation polygon = new XYShapeAnnotation(shape, stroke(weight, style), new Color(or, og, ob, oa));
    ...
    public void addXYShapeAnnotation(Env env, Shape shape, int or, int og, int ob, int oa, int fr, int fg, int fb, int fa, Float weight, String style, boolean background) {

      logger.debug("shape is [" + shape + "]");

      XYShapeAnnotation polygon = new XYShapeAnnotation(shape, stroke(weight, style), new Color(or, og, ob, oa), new Color(fr, fg, fb, fa));
    ...
    public void addPointerAnnotation(String label, String labelFont, int labelFontStyle, int labelFontSize, double x, double y, int r, int g, int b, int arrowR, int arrowG, int arrowB, int tipRadius, int baseRadius, double angle, String textAnchor, double labelOffset, Float weight, String style, Double arrowWidth) {
  ...
  protected static class WsdXYAreaChart2 extends WsdXYLineChart2 {
    ...
    private WsdXYAreaChart2(String title, String xAxis, String yAxis, boolean legend, boolean dates, String dateFormat) {
      ...
      title, xAxis, yAxis, timeDataset, PlotOrientation.VERTICAL, legend, // legend
      true, // tool tips
      false // URLs
      );
  ...
  protected static class WsdXYLineChart2 extends WsdXYChart2 {
    ...
    public void setSplineShapesFilled(boolean filled_shapes) { ((XYSplineRenderer) getChart().getXYPlot().getRenderer()).setBaseShapesFilled(filled_shapes);
    }
    ...
    public WsdXYChart2 setDateAxisRange(String lower, String upper) {
      ...
      try { ((DateAxis) plot.getDomainAxis()).setRange(sdf.parse(lower), sdf.parse(upper));
      } catch(Exception e) {
  ...
  protected static class WsdPieChart2 extends WsdChart2 {
    ...
    public void addValue(final String key, final Number n) { ((DefaultPieDataset) dataset).setValue(key, n); // new Double(43.200000000000003D));
    }
    ...
    public void setSimpleLabels(final boolean b) { ((PiePlot) getChart().getPlot()).setSimpleLabels(b);
    }

    public void setLabelBackgroundColor(int r, int g, int b, int alpha) { ((PiePlot) getChart().getPlot()).setLabelBackgroundPaint(new Color(r, g, b, alpha));
    }

    public void setLabelOutlinePaint(int r, int g, int b, int alpha) { ((PiePlot) getChart().getPlot()).setLabelOutlinePaint(new Color(r, g, b, alpha));
    }

    public void setLabelPaint(int r, int g, int b, int alpha) { ((PiePlot) getChart().getPlot()).setLabelPaint(new Color(r, g, b, alpha));
    }

    public void setLabelOutlineStroke(Float weight, String style) { ((PiePlot) getChart().getPlot()).setLabelOutlineStroke(stroke(weight, style));
    }

    public void setLabelFont(String fontName, int style, int size) { ((PiePlot) getChart().getPlot()).setLabelFont(new java.awt.Font(fontName, style, size));
    }

    public void setLabelShadowPaintOff(final boolean b) { ((PiePlot) getChart().getPlot()).setLabelShadowPaint(null);
    }

    public void setLabelShadowPaint(int r, int g, int b) { ((PiePlot) getChart().getPlot()).setLabelShadowPaint(new Color(r, g, b));
    }
